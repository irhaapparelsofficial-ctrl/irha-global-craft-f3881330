...
const homepageWithoutSlash = `<loc>${canonical}</loc>`;
const homepageWithSlash = `<loc>${canonical}/</loc>`;

if (!normalized.includes(homepageWithoutSlash) && !normalized.includes(homepageWithSlash)) {
