        ...
        <div style="max-width:1120px;margin:0 auto;padding:34px 24px 64px">
          ...
          <section style="display:grid;grid-template-columns:repeat(auto-fit,minmax(290px,1fr));gap:30px;align-items:start;padding-bottom:42px">
            ...
            <aside style="border:1px solid rgba(232,196,119,.35);background:#111;padding:24px">
              ...
              <ul style="margin:0;padding-left:20px;color:#c8c0b5">
                <li>OEM, ODM and private-label programs</li>
                <li>Sampling and buyer approval before bulk commitment</li>
                <li>Labels, tags, packaging and decoration reviewed per program</li>
                <li>MOQ, timing and pricing confirmed against the actual requirement</li>
              </ul>
          ...
          <section style="margin-top:48px;border:1px solid rgba(232,196,119,.35);background:#111;padding:28px">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:16px;margin-top:20px">
              <a href="/inquiry?intent=rfq&amp;source=${encodedSource}" style="color:#e8c477">Request a Quote</a>
              <a href="/catalogue" style="color:#e8c477">View Catalogue</a>
              <a href="/buyer-trust" style="color:#e8c477">Buyer Trust Center</a>
              <a href="/contact" style="color:#e8c477">Contact Irha Apparels</a>
            </div>
          </section>
        </div>

        <footer style="border-top:1px solid #2e2a25;background:#080808">
          <div style="max-width:1120px;margin:0 auto;padding:28px 24px;display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:20px;color:#aaa29a;font-size:13px">
            <div><strong style="color:#f5f1e8">Irha Apparels</strong><br>B2B custom apparel manufacturer<br>Sialkot, Punjab, Pakistan</div>
            <div><strong style="color:#f5f1e8">Contact</strong><br><a href="mailto:${SALES_EMAIL}" style="color:#e8c477">${SALES_EMAIL}</a><br><a href="tel:${SALES_PHONE_LINK}" style="color:#e8c477">${SALES_PHONE_DISPLAY}</a><br><a href="${WHATSAPP_URL}" style="color:#e8c477">WhatsApp</a></div>
            <div><strong style="color:#f5f1e8">Buyer links</strong><br><a href="/manufacturing" style="color:#aaa29a">Manufacturing</a><br><a href="/faq" style="color:#aaa29a">Buyer FAQ</a><br><a href="/factory-video-call" style="color:#aaa29a">Live factory call</a></div>
            <div><strong style="color:#f5f1e8">Social</strong><br><a href="https://www.instagram.com/irhaapparels/" style="color:#e8c477">Instagram @irhaapparels</a><br><span>OEM · ODM · Private Label</span></div>
          </div>
        </footer>
      </main>`;
}
...
async function main() {
  ...
  for (const file of files) {
    ...
    if (!headingHtml || !descriptionHtml) {
      throw new Error(`Unable to extract unique route heading or description for ${pathname}`);
    }
  ...
  console.log(`Enriched ${enriched} generic crawler-visible route shells with B2B contact, trust, category, process and conversion content`);
}
