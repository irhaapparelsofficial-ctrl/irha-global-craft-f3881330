    ...
    <section id="process" className="scroll-mt-24 bg-background py-12 text-foreground md:py-18">
      <div className="container-luxe">
        <div className="mb-5 grid gap-3 lg:mb-7 lg:grid-cols-12 lg:items-end">
          ...
          <p className="text-sm leading-6 text-foreground/65 lg:col-span-4 lg:leading-7">MOQ, pricing, timing and shipping are confirmed against the actual product before commitment.</p>
        </div>
          ...
          {STEPS.map(({ Icon, number, title, text }) => (
            <article key={number} className="min-w-[78%] snap-start rounded-xl border border-border/70 bg-card p-4 sm:min-w-0 sm:p-5 lg:rounded-none lg:border-0 lg:p-6">
              <div className="flex items-center justify-between">
                <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-primary/30 bg-primary/8 text-primary lg:rounded-none"><Icon size={17} strokeWidth={1.7} /></span>
