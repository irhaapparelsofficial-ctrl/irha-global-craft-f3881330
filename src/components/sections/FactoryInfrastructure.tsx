...
const metrics = [
  ...
  { value: "30 sec", label: "Self-hosted factory walkthrough slot" },
          ...
          <div className="relative min-h-[360px] overflow-hidden border border-border/60 bg-black md:min-h-[480px]">
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 p-6 md:p-8">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-white/72">
                Self-hosted HTML5 video only—no external player logo, recommendations or tracking overlay. The poster remains visible until the approved factory clip is published.
              </p>
            </div>
          </div>
