...
const ITEMS = [
  {
    ...
    text: "Made-to-order manufacturing for brands, wholesalers and importers.",
  },
  {
    Icon: ClipboardCheck,
    title: "Sample Before Bulk",
    text: "Construction, branding and requested changes are aligned before commitment.",
  },
  {
    Icon: Tags,
    title: "Custom Branding",
    text: "Printing, embroidery, labels, hangtags and packaging are scoped per product.",
  },
  {
    Icon: PackageCheck,
    title: "Export Order Review",
    text: "Quantity, destination, packing and shipping requirements are reviewed per order.",
  },
];
