...
const VERIFY = [
  {
    ...
    text: "A scheduled video call can show the working environment and discuss the buyer’s actual requirement.",
  },
  {
    Icon: Scissors,
    title: "Sample & construction",
    text: "Materials, measurements, construction details and requested revisions are reviewed before bulk commitment.",
  },
  {
    Icon: Tags,
    title: "Branding scope",
    text: "Embroidery, printing, woven labels, care labels, hangtags and packaging are confirmed per product.",
  },
  {
    Icon: PackageCheck,
    title: "Packing & dispatch",
    text: "Packing, documentation, destination and shipping arrangement are checked against the approved order.",
  },
];
        ...
        <div className="lg:col-span-5">
          <div className="relative aspect-[16/10] overflow-hidden rounded-xl border border-white/15 bg-black shadow-elegant sm:rounded-none">
            <img
              ...
              alt="Apparel manufacturing workflow reference for buyer verification"
              loading="lazy"
              decoding="async"
              width={1400}
              height={875}
