        ...
        >
          <div>
            <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.18em] text-muted-foreground">
              <Settings2 size={14} /> Advanced tools
            </div>
            <p className="mt-1 text-xs text-foreground/55">Lead activation and private-file campaign tools. Most daily outreach does not need these.</p>
          </div>
