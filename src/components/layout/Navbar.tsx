    ...
    >
      <div className="container-luxe flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <Link to={settings.ctas.quoteHref} className="min-h-11 inline-flex items-center gap-2 bg-gradient-gold text-primary-foreground px-5 py-2.5 text-[11px] uppercase tracking-[0.25em] font-medium hover:shadow-gold transition-all">
