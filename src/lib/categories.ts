...
export const CATEGORIES: Category[] = [
    ...
    products: [
      {
        ...
        details: mk("Genuine deer / goat suede + cotton-linen blends", "Suede 220–260 GSM / cotton 180–220 GSM", "flexible MOQ per design and color", "45–60 days FOB Sialkot", "EU 44–60 men / XS–XXL women / kids 2–14", "Antique brown, forest green, burgundy, custom", "Individual poly bag + branded gift box", "certified fabrics on request, regulatory-aligned", "Private label, embroidery, branded hangtags & labels"),
      },
      {
    ...
    products: [
      {
        ...
        details: mk("Full-grain cowhide / napa lambskin 1.0–1.4mm", "Leather equivalent 280–320 GSM", "30–flexible MOQ per style", "50–65 days FOB", "XS–4XL extended sizing", "Black, antique brown, oxblood, custom dyes", "Tissue + branded box + dust bag", "certified, regulatory-documentation-as-required, vetted tannery", "Custom hardware, lining, embroidery, label & hangtag"),
      },
      {
    ...
    products: [
      {
        ...
        details: mk("Polyester micro-mesh / 4-way stretch 140–180 GSM", "140–180 GSM", "our flexible MOQ per kit / 100 per jersey", "30–40 days FOB", "XS–5XL adult & youth", "Full Pantone match via dye-sublimation", "Individual poly bag + team-pack carton", "certified fabrics on request, documented", "Full sublimation, team names/numbers, sponsor logos"),
      },
      {
    ...
    products: [
      {
        ...
        details: mk("Heavyweight French Terry / brushed fleece 330–450 GSM", "330–450 GSM", "flexible MOQ per design and color", "35–50 days FOB", "XS–4XL relaxed & oversized", "Black, off-white, vintage wash, custom dye", "Individual poly bag + branded carton", "certified fabrics on request, GRS option for recycled cotton", "Garment dye, enzyme wash, embroidery, screen & DTG"),
      },
      {
  ...
  },
  {
    ...
    details: ["Cotton, modal, satin & silk blends", "certified fabrics on request certified", "Lace & embroidery options", "Hospitality & hotel programs"],
    products: [
      {
