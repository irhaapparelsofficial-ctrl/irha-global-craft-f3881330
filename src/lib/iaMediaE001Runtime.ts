...
const MEDIA_VERSION = "ia-media-e001-20260730";

const media = (productCode: string, slug: string, files: string[]): ProductRealMedia => ({
  gallery: files.map((file) => `${STORAGE_ORIGIN}/catalog/products/${productCode}-${slug}/${MEDIA_VERSION}/${file}`),
});

export const IA_MEDIA_E001_PRODUCT_MEDIA: Readonly<Record<string, ProductRealMedia>> = Object.freeze({
  "short-lederhosen": media("p001", "short-lederhosen", [
  ...
  "knee-length-lederhosen": media("p002", "knee-length-lederhosen", [
  ...
  "long-lederhosen": media("p003", "long-lederhosen", [
  ...
  "vintage-lederhosen": media("p004", "vintage-lederhosen", [
  ...
  "premium-embroidered-lederhosen": media("p005", "premium-embroidered-lederhosen", [
  ...
  "goat-suede-lederhosen": media("p006", "goat-suede-lederhosen", [
  ...
  "deer-suede-lederhosen": media("p007", "deer-suede-lederhosen", [
