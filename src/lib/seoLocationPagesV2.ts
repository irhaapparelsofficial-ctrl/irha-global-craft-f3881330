...
const CITY: Record<string, CityData> = {
  Paris:       { city: "Paris", country: "France", region: "Europe", shippingLane: "Sialkot → Le Havre / Marseille", transitDays: "22–28 days FOB · 5–7 days air", duties: "Pakistan GSP+ status grants reduced or zero EU import duty on most apparel with Form A documentation." },
  Milan:       { city: "Milan", country: "Italy", region: "Europe", shippingLane: "Sialkot → Genoa / La Spezia", transitDays: "21–27 days FOB · 5–7 days air", duties: "Pakistan GSP+ status grants reduced or zero EU import duty on most apparel categories." },
  Madrid:      { city: "Madrid", country: "Spain", region: "Europe", shippingLane: "Sialkot → Barcelona / Valencia", transitDays: "22–28 days FOB · 5–7 days air", duties: "EU GSP+ preferential tariffs apply to Pakistan-origin apparel with Form A." },
  Barcelona:   { city: "Barcelona", country: "Spain", region: "Europe", shippingLane: "Sialkot → Barcelona", transitDays: "21–27 days FOB · 5–7 days air", duties: "EU GSP+ preferential tariffs apply to Pakistan-origin apparel with Form A." },
  Amsterdam:   { city: "Amsterdam", country: "Netherlands", region: "Europe", shippingLane: "Sialkot → Rotterdam", transitDays: "20–26 days FOB · 5–7 days air", duties: "Rotterdam is the EU gateway port — GSP+ reduces duty on Pakistan-origin apparel substantially." },
  Copenhagen:  { city: "Copenhagen", country: "Denmark", region: "Europe", shippingLane: "Sialkot → Aarhus / Hamburg → Copenhagen", transitDays: "24–30 days FOB · 5–7 days air", duties: "EU GSP+ preferential tariffs apply with Form A documentation." },
  Stockholm:   { city: "Stockholm", country: "Sweden", region: "Europe", shippingLane: "Sialkot → Gothenburg → Stockholm", transitDays: "25–31 days FOB · 5–7 days air", duties: "EU GSP+ preferential tariffs apply with Form A." },
  Oslo:        { city: "Oslo", country: "Norway", region: "Europe", shippingLane: "Sialkot → Oslo via Hamburg", transitDays: "26–32 days FOB · 5–7 days air", duties: "Norway-EFTA tariffs apply; Pakistan GSP equivalents reduce duty significantly with origin documentation." },
  Helsinki:    { city: "Helsinki", country: "Finland", region: "Europe", shippingLane: "Sialkot → Helsinki via Hamburg", transitDays: "26–32 days FOB · 5–7 days air", duties: "EU GSP+ preferential tariffs apply with Form A." },
  Brussels:    { city: "Brussels", country: "Belgium", region: "Europe", shippingLane: "Sialkot → Antwerp", transitDays: "21–27 days FOB · 5–7 days air", duties: "EU GSP+ via Antwerp — major apparel customs hub for the Benelux." },
  Vienna:      { city: "Vienna", country: "Austria", region: "Europe", shippingLane: "Sialkot → Hamburg → Vienna", transitDays: "25–31 days FOB · 5–7 days air", duties: "EU GSP+ preferential tariffs apply with Form A documentation." },
  Zurich:      { city: "Zurich", country: "Switzerland", region: "Europe", shippingLane: "Sialkot → Hamburg → Zurich", transitDays: "26–32 days FOB · 5–7 days air", duties: "Swiss GSP grants zero duty on most apparel from Pakistan with Form A." },
  Frankfurt:   { city: "Frankfurt", country: "Germany", region: "Europe", shippingLane: "Sialkot → Hamburg → Frankfurt", transitDays: "22–28 days FOB · 5–7 days air", duties: "Pakistan GSP+ grants reduced or zero EU duty on apparel with Form A." },
  Hamburg:     { city: "Hamburg", country: "Germany", region: "Europe", shippingLane: "Sialkot → Hamburg direct", transitDays: "21–26 days FOB · 5–7 days air", duties: "Pakistan GSP+ grants reduced or zero EU duty on apparel with Form A." },
  Cologne:     { city: "Cologne", country: "Germany", region: "Europe", shippingLane: "Sialkot → Hamburg → Cologne", transitDays: "23–28 days FOB · 5–7 days air", duties: "Pakistan GSP+ grants reduced or zero EU duty on apparel with Form A." },
  Birmingham:  { city: "Birmingham", country: "UK", region: "Europe", shippingLane: "Sialkot → Felixstowe / Southampton → Birmingham", transitDays: "23–29 days FOB · 5–7 days air", duties: "Post-Brexit UK Global Tariff applies; UK-Pakistan DCTS scheme grants reduced duty on most apparel." },
  Glasgow:     { city: "Glasgow", country: "UK", region: "Europe", shippingLane: "Sialkot → Grangemouth / Greenock", transitDays: "24–30 days FOB · 5–7 days air", duties: "UK DCTS scheme grants reduced duty on Pakistan-origin apparel." },
  Dublin:      { city: "Dublin", country: "Ireland", region: "Europe", shippingLane: "Sialkot → Dublin via Rotterdam", transitDays: "24–30 days FOB · 5–7 days air", duties: "EU GSP+ preferential tariffs apply with Form A." },
  Chicago:     { city: "Chicago", country: "USA", region: "North America", shippingLane: "Sialkot → New York → Chicago (rail)", transitDays: "30–36 days FOB · 5–7 days air", duties: "US HTS tariffs apply; we handle Form A and assist with US CBP documentation." },
  Miami:       { city: "Miami", country: "USA", region: "North America", shippingLane: "Sialkot → Miami via Savannah", transitDays: "30–36 days FOB · 5–7 days air", duties: "US HTS tariffs apply; Miami is a major LATAM re-export hub." },
  Houston:     { city: "Houston", country: "USA", region: "North America", shippingLane: "Sialkot → Houston", transitDays: "32–38 days FOB · 5–7 days air", duties: "US HTS tariffs apply per category." },
  Boston:      { city: "Boston", country: "USA", region: "North America", shippingLane: "Sialkot → New York → Boston", transitDays: "29–35 days FOB · 5–7 days air", duties: "US HTS tariffs apply; Form A handled in-house." },
  SanFrancisco:{ city: "San Francisco", country: "USA", region: "North America", shippingLane: "Sialkot → Oakland / Long Beach", transitDays: "26–32 days FOB · 5–7 days air", duties: "US HTS tariffs apply; West Coast lane is fastest for US programs." },
  Montreal:    { city: "Montreal", country: "Canada", region: "North America", shippingLane: "Sialkot → Montreal", transitDays: "28–34 days FOB · 5–7 days air", duties: "Canada GPT/LDCT grants reduced or zero duty on Pakistan-origin apparel with Form A." },
  Vancouver:   { city: "Vancouver", country: "Canada", region: "North America", shippingLane: "Sialkot → Vancouver", transitDays: "26–32 days FOB · 5–7 days air", duties: "Canada GPT grants reduced duty on Pakistan-origin apparel with Form A." },
  Melbourne:   { city: "Melbourne", country: "Australia", region: "Asia Pacific", shippingLane: "Sialkot → Melbourne", transitDays: "25–31 days FOB · 6–8 days air", duties: "Australia 5% general tariff applies; preferential schemes via Certificate of Origin." },
  Brisbane:    { city: "Brisbane", country: "Australia", region: "Asia Pacific", shippingLane: "Sialkot → Brisbane", transitDays: "25–31 days FOB · 6–8 days air", duties: "Australia 5% general tariff applies on most apparel HS lines." },
  Perth:       { city: "Perth", country: "Australia", region: "Asia Pacific", shippingLane: "Sialkot → Fremantle", transitDays: "21–27 days FOB · 6–8 days air", duties: "Australia 5% general tariff applies." },
  Auckland:    { city: "Auckland", country: "New Zealand", region: "Asia Pacific", shippingLane: "Sialkot → Auckland", transitDays: "28–34 days FOB · 7–9 days air", duties: "NZ general apparel tariff typically 5–10%; preferential schemes apply with Form A." },
  Tokyo:       { city: "Tokyo", country: "Japan", region: "Asia Pacific", shippingLane: "Sialkot → Tokyo / Yokohama", transitDays: "21–27 days FOB · 4–6 days air", duties: "Japan GSP grants reduced duty on Pakistan-origin apparel with Form A." },
  Osaka:       { city: "Osaka", country: "Japan", region: "Asia Pacific", shippingLane: "Sialkot → Osaka / Kobe", transitDays: "20–26 days FOB · 4–6 days air", duties: "Japan GSP grants reduced duty on Pakistan-origin apparel with Form A." },
  Seoul:       { city: "Seoul", country: "South Korea", region: "Asia Pacific", shippingLane: "Sialkot → Busan → Seoul", transitDays: "20–26 days FOB · 4–6 days air", duties: "Korea GSP grants reduced duty on Pakistan-origin apparel with Form A." },
  Singapore:   { city: "Singapore", country: "Singapore", region: "Asia Pacific", shippingLane: "Sialkot → Singapore", transitDays: "12–18 days FOB · 3–5 days air", duties: "Singapore is a zero-duty entrepôt for most apparel — ideal SEA distribution hub." },
  HongKong:    { city: "Hong Kong", country: "Hong Kong SAR", region: "Asia Pacific", shippingLane: "Sialkot → Hong Kong", transitDays: "14–20 days FOB · 3–5 days air", duties: "Hong Kong is a free port — zero import duty on apparel." },
  Bangkok:     { city: "Bangkok", country: "Thailand", region: "Asia Pacific", shippingLane: "Sialkot → Laem Chabang → Bangkok", transitDays: "14–20 days FOB · 4–6 days air", duties: "Thailand tariffs apply per HS line; Pakistan-Thailand preferential schemes via Certificate of Origin." },
  KualaLumpur: { city: "Kuala Lumpur", country: "Malaysia", region: "Asia Pacific", shippingLane: "Sialkot → Port Klang", transitDays: "13–19 days FOB · 4–6 days air", duties: "Malaysia general apparel tariffs apply; preferential ASEAN-Pakistan rates on selected HS lines." },
  AbuDhabi:    { city: "Abu Dhabi", country: "UAE", region: "Middle East", shippingLane: "Sialkot → Jebel Ali → Abu Dhabi", transitDays: "5–8 days FOB · 2–3 days air", duties: "UAE applies 5% GCC common external tariff; many free-zone re-exports are duty-exempt." },
  Sharjah:     { city: "Sharjah", country: "UAE", region: "Middle East", shippingLane: "Sialkot → Sharjah", transitDays: "5–8 days FOB · 2–3 days air", duties: "UAE 5% GCC tariff applies; free-zone re-exports exempt." },
  Riyadh:      { city: "Riyadh", country: "Saudi Arabia", region: "Middle East", shippingLane: "Sialkot → Jeddah → Riyadh", transitDays: "10–14 days FOB · 3–5 days air", duties: "Saudi Arabia applies 5–15% GCC tariff depending on HS line; SASO certification required for retail entry." },
  Doha:        { city: "Doha", country: "Qatar", region: "Middle East", shippingLane: "Sialkot → Hamad Port Doha", transitDays: "8–12 days FOB · 3–5 days air", duties: "Qatar applies 5% GCC tariff on apparel imports." },
  KuwaitCity:  { city: "Kuwait City", country: "Kuwait", region: "Middle East", shippingLane: "Sialkot → Shuwaikh / Shuaiba", transitDays: "8–12 days FOB · 3–5 days air", duties: "Kuwait applies 5% GCC tariff; many programs route via Jebel Ali free zone." },
  Manama:      { city: "Manama", country: "Bahrain", region: "Middle East", shippingLane: "Sialkot → Khalifa Bin Salman Port", transitDays: "8–12 days FOB · 3–5 days air", duties: "Bahrain applies 5% GCC tariff on apparel." },
};
...
const EXTRA_HAND_CRAFTED: SeoLandingPage[] = [
  ...
  buildLocationPage({
    ...
    ...CITY.SanFrancisco, city: "Los Angeles", shippingLane: "Sialkot → Long Beach / Los Angeles",
    ...
    faqs: [
      ...
      { q: "What is the MOQ?", a: "flexible MOQ per design per colourway; LA sample programs accepted at 25 pieces split across 2 colourways." },
      ...
      { q: "What lambskin grades do you offer?", a: "A and B grade lambskin from vetted tanneries, chromium-VI tested per US CPSIA and California Prop 65." },
  ...
  buildLocationPage({
    ...
    faqs: [
      ...
      { q: "What leathers are used?", a: "Nappa lambskin, peccary, cabretta, deerskin — all vetted-rated, regulatory-aligned, chromium-VI tested." },
  ...
  buildLocationPage({
    ...
    faqs: [
      ...
      { q: "Do you ship by sea to Genoa?", a: "Yes — Sialkot → Genoa direct, 21–27 days; LCL available under 1 CBM." },
      { q: "Can you produce vegetable-tanned leather bags?", a: "Yes — vetted-rated tannery partners supply vegetable-tanned and chrome-free full-grain cowhide for premium Italian programs." },
  ...
  buildLocationPage({
    ...
    uniqueAngle: "Dutch buyers prioritise narrow hip block patterns, longer rise, vegan-PU compliance to EU regulatory-documentation-as-required and certified-recycled lining options — Amsterdam programs ship with full regulatory-documentation-as-required and certified documentation as standard.",
    capabilities: [
      ...
      { title: "Vegan PU pants", body: "regulatory-aligned PU faux leather on cotton-poly base with water-based coating." },
      { title: "Zip-detail & punk", body: "Multi-zipper, lace-up and asymmetric closure designs for Amsterdam alternative scenes." },
      { title: "EU-compliant labelling", body: "Dutch/English care labels (ISO 3758), fibre composition per EU Regulation 1007/2011, certified fabrics on request." },
    ],
    faqs: [
      { q: "Do you ship to Rotterdam?", a: "Yes — Sialkot → Rotterdam 20–26 days direct, with onward DDP delivery to Amsterdam warehouses." },
      { q: "Are vegan leather pants available?", a: "Yes — PU faux leather, regulatory-aligned base, water-based coating, full vegan-certified supply chain on request." },
      { q: "What is the MOQ?", a: "flexible MOQ per design per colourway; sample orders 10–20 pieces ship by air to Amsterdam in 5–7 days." },
      { q: "Are leather pants regulatory-aligned?", a: "Yes — chromium-VI tested below 3 ppm per EU regulatory dye limits per market." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "Do you ship to Tokyo?", a: "Yes — Sialkot → Tokyo / Yokohama 21–27 days; air freight 4–6 days for samples." },
      ...
      { q: "What is the MOQ?", a: "flexible MOQ per design per colourway; 25-piece sample runs accepted." },
      { q: "Do you produce horsehide jackets?", a: "Yes — heavy horsehide from vetted-rated tannery partners for vintage repro programs." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "Do you ship to Singapore?", a: "Yes — Sialkot → Singapore 12–18 days; air freight 3–5 days for samples." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "What MOQ applies for Lederhosen programs?", a: "flexible MOQ per design per colourway; mixed-size packs (44–58) at 5–8 pieces per size standard." },
      { q: "Do you ship to Frankfurt?", a: "Yes — Sialkot → Hamburg → Frankfurt 22–28 days; DDP delivery available." },
      { q: "What leathers are used?", a: "Authentic deerskin (Hirschleder) and goat-suede from vetted-rated tannery partners." },
  ...
  buildLocationPage({
    ...
    capabilities: [
      ...
      { title: "EU-compliant labelling", body: "German care labels (ISO 3758), fibre composition per EU 1007/2011, certified fabrics on request." },
    ],
    faqs: [
      { q: "What MOQ applies for Hamburg Dirndl programs?", a: "flexible MOQ per design per colourway; mixed-size packs (32–46) at 5–8 pieces per size." },
      { q: "Do you ship to Hamburg?", a: "Yes — Sialkot → Hamburg direct 21–26 days; DDP available." },
      { q: "Are complete sets available?", a: "Yes — bodice, skirt, apron and blouse coordinated sets in matching fabrics." },
      { q: "What fabrics are used?", a: "Cotton-blend bodice fabrics, polyester-cotton skirts, lace and broderie aprons — all material spec confirmed per program." },
  ...
  buildLocationPage({
    ...
    capabilities: [
      ...
      { title: "EU-compliant labelling", body: "German care labels (ISO 3758), fibre composition per EU 1007/2011, certified." },
    ],
    faqs: [
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
      { q: "Do you ship to Cologne?", a: "Yes — Sialkot → Hamburg → Cologne 23–28 days; DDP delivery available." },
      ...
      { q: "Do you provide German labelling?", a: "Yes — German care labels, fibre composition, certified fabrics on request certification per shipment." },
    ],
  }),
  buildLocationPage({
    ...
    capabilities: [
      ...
      { title: "EU-compliant labelling", body: "Multi-language care labels, fibre composition, certified certification." },
    ],
    faqs: [
      ...
      { q: "Do you ship to Antwerp?", a: "Yes — Sialkot → Antwerp 21–27 days; DDP delivery to Brussels warehouses." },
      { q: "What MOQ applies for festival programs?", a: "flexible MOQ per design per colourway; volume tiers at 200, 500, 1,000, 2,000." },
  ...
  buildLocationPage({
    ...
    shippingLane: "Sialkot → Montreal / Toronto",
    ...
    faqs: [
      { q: "Do you ship to Toronto?", a: "Yes — Sialkot → Toronto 28–34 days via Montreal; DDP delivery available." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway; volume tiers at 200, 500, 1,000 for festival operators." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway; team programs at 25-piece minimum splits." },
      { q: "Do you ship to Genoa?", a: "Yes — Sialkot → Genoa 21–27 days direct; DDP to Milan available." },
      { q: "Can you sublimate team jerseys?", a: "Yes — full-sublimation polyester tracksuits with sponsor logos, player names and numbers." },
      { q: "What fabrics are used?", a: "280–400 GSM cotton-poly fleece, French terry, sublimated polyester — all material spec confirmed per program." },
  ...
  buildLocationPage({
    ...
    faqs: [
      ...
      { q: "Do you ship to Stockholm?", a: "Yes — Sialkot → Gothenburg → Stockholm 25–31 days; DDP delivery available." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway; mixed-size packs (XS–XXL) at 6–10 per size." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "What MOQ applies for Madrid team programs?", a: "flexible MOQ per design; team programs split across 25-piece per-size minimums." },
      { q: "Do you ship to Madrid?", a: "Yes — Sialkot → Barcelona / Valencia 22–28 days; DDP to Madrid available." },
      ...
      { q: "What fabrics are used?", a: "150–180 GSM sublimated polyester with mesh ventilation panels — material spec confirmed per program." },
    ],
  }),
  buildLocationPage({
    ...
    faqs: [
      { q: "Do you ship to Seoul?", a: "Yes — Sialkot → Busan → Seoul 20–26 days; air freight 4–6 days for samples." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "Do you ship to Singapore?", a: "Yes — Sialkot → Singapore 12–18 days direct; air freight 3–5 days." },
  ...
  buildLocationPage({
    ...
    uniqueAngle: "Amsterdam buyers demand GRS-certified recycled fabric, EU regulatory documentation as required, inclusive sizing (XS–3XL with separate cup grading) and Nordic minimalist aesthetics — our Amsterdam program ships to these benchmarks as default.",
    capabilities: [
    ...
    faqs: [
      ...
      { q: "Do you ship to Rotterdam?", a: "Yes — Sialkot → Rotterdam 20–26 days direct; DDP to Amsterdam available." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway; cup-graded packs at 8–10 per size." },
      { q: "Is inclusive sizing available?", a: "Yes — XS to 3XL with separate cup grading (A to DD)." },
      { q: "Are regulatory-aligned fabrics standard?", a: "Yes — all fabrics tested per EU regulatory-documentation-as-required with reports per shipment." },
    ],
  }),
  buildLocationPage({
    ...
    faqs: [
      ...
      { q: "Do you ship to Riyadh?", a: "Yes — Sialkot → Jeddah → Riyadh 10–14 days; air freight 3–5 days." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway; volume tiers at 100, 500, 1,000, 5,000." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "Do you ship to Seoul?", a: "Yes — Sialkot → Busan → Seoul 20–26 days; air freight 4–6 days." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
  ...
  buildLocationPage({
    ...
    shippingLane: "Sialkot → Long Beach / Los Angeles",
    transitDays: "24–30 days FOB · 5–7 days air",
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
      { q: "Do you ship to Milan?", a: "Yes — Sialkot → Genoa 21–27 days direct; DDP to Milan available." },
      { q: "Are Italian-fit pattern blocks available?", a: "Yes — slim and tapered Italian-fit pattern blocks." },
      { q: "What fabrics are used?", a: "Ripstop cotton, 320 GSM cotton twill, nylon-cotton blends — all material spec confirmed per program." },
  ...
  buildLocationPage({
    ...
    shippingLane: "Sialkot → Sydney / Port Botany",
    ...
    faqs: [
      { q: "Do you ship to Sydney?", a: "Yes — Sialkot → Port Botany 24–30 days direct." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
  ...
  buildLocationPage({
    ...
    uniqueAngle: "Amsterdam buyers demand organic-on-request-certified organic cotton, GRS-certified recycled polyester, EU regulatory documentation as required and EU GPSR-compliant labelling — our Amsterdam program ships to these specs as default.",
    capabilities: [
      { title: "organic cotton", body: "organic-on-request-certified organic cotton in 280–400 GSM French terry and brushed-back fleece." },
      ...
      { title: "EU regulatory documentation as required", body: "All dyes and trims tested per EU regulatory-documentation-as-required; reports per shipment." },
      { title: "Premium printing", body: "Water-based, discharge, high-density plastisol and embroidery." },
      { title: "EU GPSR-compliant labelling", body: "EU GPSR-compliant care labels, fibre composition, certified." },
    ],
    faqs: [
      { q: "Is organic cotton available?", a: "Yes — organic-on-request-certified organic cotton with full chain-of-custody documentation." },
      { q: "Do you ship to Rotterdam?", a: "Yes — Sialkot → Rotterdam 20–26 days direct; DDP to Amsterdam available." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
      { q: "Is heavyweight 400+ GSM fleece available?", a: "Yes — premium 400–550 GSM French terry and brushed-back fleece." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "Do you ship to Tokyo?", a: "Yes — Sialkot → Tokyo / Yokohama 21–27 days; air freight 4–6 days." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "Do you ship to Tokyo?", a: "Yes — Sialkot → Tokyo 21–27 days; air freight 4–6 days." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
      { q: "Is supima cotton available?", a: "Yes — premium long-staple supima cotton from certified mill partners." },
      { q: "Are bamboo-cotton blends available?", a: "Yes — bamboo-cotton blends with certified certification." },
      { q: "Do you provide Japanese-language packaging?", a: "Yes — Japanese care labels, hangtags and JAN barcoding." },
    ],
  }),
  buildLocationPage({
    ...
    uniqueAngle: "Zurich buyers demand premium 450–550 GSM terry weight, certified fabrics on request certification, embroidered hotel monograms and Swiss-quality finishing — our Zurich program ships to these benchmarks as default.",
    capabilities: [
      ...
      { title: "EU-compliant labelling", body: "Multi-language care labels, fibre composition, certified fabrics on request." },
    ],
    faqs: [
      ...
      { q: "Do you ship to Zurich?", a: "Yes — Sialkot → Hamburg → Zurich 26–32 days; DDP delivery available." },
  ...
  buildLocationPage({
    ...
    uniqueAngle: "Vienna buyers demand organic-on-request-certified organic cotton, EU regulatory documentation as required, German-language packaging and EU GPSR-compliant labelling — our Vienna program ships to these specs as default.",
    capabilities: [
      { title: "organic cotton sets", body: "organic-on-request-certified organic cotton casual sets with full chain-of-custody." },
      ...
      { title: "Sustainable certifications", body: "organic-on-request, GRS, certified fabrics on request with full chain-of-custody." },
    ],
    faqs: [
      { q: "Is organic cotton available?", a: "Yes — organic-on-request-certified organic cotton with full chain-of-custody documentation." },
      { q: "Do you ship to Vienna?", a: "Yes — Sialkot → Hamburg → Vienna 25–31 days; DDP delivery available." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
  ...
  buildLocationPage({
    ...
    faqs: [
      { q: "Do you ship to Los Angeles?", a: "Yes — Sialkot → Long Beach 24–30 days; DDP delivery via LA 3PLs." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
  ...
  buildLocationPage({
    ...
    uniqueAngle: "Amsterdam buyers demand organic-on-request-certified organic cotton, GRS-certified recycled polyester, EU regulatory documentation as required, EU GPSR-compliant labelling and Dutch-language packaging — our Amsterdam program ships to these specs as default.",
    capabilities: [
      { title: "organic cotton sets", body: "organic-on-request-certified organic cotton sets with full chain-of-custody." },
    ...
    faqs: [
      { q: "Is organic cotton available?", a: "Yes — organic-on-request-certified organic cotton with full chain-of-custody." },
      { q: "Do you ship to Rotterdam?", a: "Yes — Sialkot → Rotterdam 20–26 days direct." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
      { q: "Is EU GPSR compliance handled?", a: "Yes — EU GPSR-compliant labelling and packaging per shipment." },
...
const T: Record<string, ProductTemplate> = {
  leatherJacket: {
    ...
    faqs: [
      { q: "What leather grades do you offer?", a: "A and B grade full-grain cowhide, lambskin, goatskin and nappa — all from vetted tanneries with chromium-VI tested below regulatory-documentation-as-required limits." },
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway; 25-piece sample runs accepted across 2 colourways." },
      ...
      { q: "Are CPSIA / Prop 65 compliance tested?", a: "Yes — chromium-VI testing, regulatory documentation as required and CPSIA test reports per shipment." },
    ],
  ...
  leatherGloves: {
    ...
    faqs: [
      ...
      { q: "What leathers are used?", a: "Nappa lambskin, deerskin, peccary, cowhide split, goatskin and cabretta — all vetted-rated, regulatory-aligned." },
  ...
  leatherPants: {
    ...
    capabilities: [
      ...
      { title: "Faux-leather PU programs", body: "Vegan PU leather pants — regulatory-aligned base fabric, water-based PU coating." },
      { title: "Regional fit blocks", body: "City-specific pattern blocks engineered from years of regional client feedback." },
    ],
    faqs: [
      { q: "Are leather pants regulatory-aligned?", a: "Yes — chromium-VI tested below 3 ppm per EU regulatory dye limits per market." },
      { q: "Do you offer vegan leather pants?", a: "Yes — PU faux leather on cotton-poly base, regulatory-aligned, water-based coating, vegan-certified supply chain." },
      { q: "What is the MOQ?", a: "flexible MOQ per design per colourway." },
  ...
  leatherBags: {
    ...
    faqs: [
      ...
      { q: "Can you produce vegetable-tanned leather?", a: "Yes — vetted-rated tannery partners supply vegetable-tanned and chrome-free full-grain cowhide." },
  ...
  lederhosen: {
    ...
    faqs: [
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway; mixed-size packs (44–58) at 5–8 per size." },
      { q: "What leathers are used?", a: "Authentic deerskin (Hirschleder) and goat-suede from vetted-rated tannery partners." },
      { q: "Are children's sizes available?", a: "Yes — sizes 86–164 cm with matching embroidery and antler-button construction." },
  ...
  dirndl: {
    ...
    intro: (city) => `${city} Dirndl buyers — Trachten retailers, festival operators and Oktoberfest-aligned hospitality programs — source from Irha Apparels for authentic Dirndl construction with regional fit blocks, complete sets and certified-certified fabrics at factory-direct prices.`,
  ...
  jerseys: {
    ...
    faqs: [
      { q: "What MOQ applies?", a: "flexible MOQ per design; team programs split across 25-piece per-size minimums." },
  ...
  hoodie: {
    ...
    capabilities: [
      ...
      { title: "Premium hardware", body: "Metal eyelets, branded drawcords, embossed leather tags." },
      { title: "Sustainable fabrics", body: "organic cotton and GRS recycled polyester options with full chain-of-custody." },
    ],
    faqs: [
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
      { q: "Is heavyweight 400+ GSM fleece available?", a: "Yes — premium 400–550 GSM French terry and brushed-back fleece." },
  ...
  loungewear: {
    ...
    capabilities: [
      ...
      { title: "Garment-dyed pigment", body: "Garment-dyed pigment finishes for vintage-look programs." },
      { title: "DTC e-commerce packaging", body: "Recycled poly mailers, gift-receipt inserts, branded tissue paper for DTC programs." },
      { title: "organic cotton", body: "organic-on-request-certified organic cotton with full chain-of-custody." },
    ],
    faqs: [
      { q: "What MOQ applies?", a: "flexible MOQ per design per colourway." },
      { q: "Is supima cotton available?", a: "Yes — premium long-staple supima cotton from certified mill partners." },
  ...
  robes: {
    ...
    faqs: [
      ...
      { q: "Is certified certification standard?", a: "Yes — material spec confirmed per program per shipment." },
    ],
    ...
    angle: (city) => `${city} buyers demand premium terry weight, certified certification, embroidered hotel monograms and luxury-grade finishing — our ${city} program ships to these benchmarks as default.`,
  },
  casualSets: {
