...
/**
 * Stable, product-first homepage imagery.
 * These are verified primary catalogue assets without the baked-in titles and
 * watermarks used by the social/OG artwork that previously appeared in cards.
 */
export const CATEGORY_HERO_MEDIA = {
  "bavarian-trachten-wear": `${SITE_MEDIA_ROOT}/catalog-migrated/2117103c-1fb1-4f71-afdd-74991a451c5b/cf2f53e806eaa0270e36.webp`,
