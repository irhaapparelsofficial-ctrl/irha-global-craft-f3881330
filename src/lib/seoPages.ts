...
export const SEO_PAGES: SeoLandingPage[] = [
  // ─────────────── 1. SPORTSWEAR PAKISTAN ───────────────
  {
    ...
    metaDescription:
      "Leading sportswear manufacturer in Pakistan. OEM/ODM activewear, sublimated jerseys, tracksuits & gym wear. MOQ 50. Export USA, UK, EU, UAE, Australia.",
    ...
    whyChoose: [
      ...
      { title: "Low MOQ for start-ups", body: "50 sets per design and colorway is our standard MOQ. Multi-color splits accepted from 25 sets per colorway — letting emerging activewear brands launch a full collection without warehousing risk." },
    ...
    faqs: [
      ...
      { q: "Can you produce small test orders for a new brand launch?", a: "Yes. Our Start-Up Program supports first-time brands with hand-holding on tech-packing, sampling, branding and shipping — at the standard 50-set MOQ, on the same production lines used for established labels." },
    ],
  ...
  // ─────────────── 2. SPORTSWEAR SIALKOT ───────────────
  {
    ...
    metaDescription:
      "Sportswear manufacturer in Sialkot, Pakistan. Custom jerseys, tracksuits & teamwear from the world's sporting-goods capital. MOQ 50. Worldwide export.",
  ...
  // ─────────────── 3. PRIVATE LABEL SPORTSWEAR ───────────────
  {
    ...
    metaDescription:
      "Private label sportswear manufacturer for DTC brands & retailers. Your brand, our factory. MOQ 50. Full white-label packaging. Worldwide export.",
    ...
    whyChoose: [
      ...
      { title: "Low MOQ launch program", body: "50 pieces per design and colorway. Multi-color splits accepted from 25 pieces per colorway — enough volume for a real launch without warehousing risk." },
    ...
    faqs: [
      ...
      { q: "What is the MOQ for private label sportswear?", a: "50 pieces per design and colorway, with free size splits XS–4XL. Multi-color splits accepted from 25 pieces per colorway. No setup or hidden fees." },
  ...
  // ─────────────── 4. LEATHERWEAR PAKISTAN ───────────────
  {
    ...
    metaDescription:
      "Premium leatherwear manufacturer in Pakistan. Lambskin, cowhide & suede jackets, vests, trousers. OEM/ODM MOQ 50. Export USA, UK, EU, UAE.",
    ...
    whyChoose: [
      { title: "LWG-rated tannery supply", body: "All hides sourced from Leather Working Group Gold and Silver-rated tanneries with full REACH Annex XVII azo-dye and CITES compliance documentation." },
  ...
  // ─────────────── 5. LEATHER JACKET MANUFACTURER ───────────────
  {
    ...
    metaDescription:
      "Premium leather jacket manufacturer. Biker, moto, bomber & varsity jackets in lambskin, cowhide & suede. MOQ 50. Export worldwide from Sialkot.",
    ...
    whyChoose: [
      ...
      { title: "REACH & CITES documented", body: "Every hide bundle ships with REACH Annex XVII azo-dye compliance, LWG audit reference and CITES documentation where applicable — clean import for EU, US and UK customs." },
    ],
    capabilities: [
  ...
  // ─────────────── 6. LEDERHOSEN MANUFACTURER ───────────────
  {
    ...
    metaDescription:
      "Authentic lederhosen manufacturer in Pakistan. Genuine deer suede, hand embroidery, MOQ 50 sets. Wholesale export to Germany, Austria, USA.",
    ...
    intro: [
      ...
      "Our Bavarian wear program is the largest export category in our factory — we ship full container loads and weekly air-freight orders to importers and Oktoberfest retailers in Munich, Vienna, Salzburg, Innsbruck, Zurich and across the Alpine region. Every shipment includes EU customs paperwork, REACH Annex XVII azo-dye compliance certificates and OEKO-TEX Standard 100 documentation as standard.",
      "Whether you are a single trachten boutique sourcing 50 sets for the Oktoberfest season, a trachten chain placing 1,000+ sets for retail floors, or a private-label distributor building your own brand of Bavarian wear, our lederhosen manufacturing program scales from prototype to bulk without compromising on suede quality, embroidery density or finishing craft.",
    ],
    whyChoose: [
      { title: "Genuine deer suede sourcing", body: "Heritage sets cut from 1.2–1.4 mm genuine deer suede; entry programs use top-grain cowhide split suede. Both are vegetable-tanned at LWG-audited tanneries and REACH compliant." },
  ...
  // ─────────────── 7. TRACHTEN MANUFACTURER ───────────────
  {
    ...
    metaDescription:
      "Authentic trachten manufacturer in Pakistan. Dirndl, lederhosen, blouses, shirts & vests. MOQ 50. Wholesale export to Germany, Austria, Switzerland.",
    ...
    whyChoose: [
      ...
      { title: "EU-clean documentation", body: "REACH Annex XVII azo-dye, OEKO-TEX Standard 100, LWG tannery references and EU customs paperwork — every shipment cleanly imports to Germany, Austria, Switzerland." },
  ...
  // ─────────────── 8. OKTOBERFEST CLOTHING ───────────────
  {
    ...
    metaDescription:
      "Oktoberfest clothing manufacturer. Wholesale lederhosen, dirndl, trachten shirts & accessories. MOQ 50. Export Germany, Austria, USA, worldwide.",
    ...
    whyChoose: [
      ...
      { title: "EU customs ready", body: "REACH, OEKO-TEX, LWG documentation per shipment. EU customs averages 5 working days from Hamburg/Rotterdam. DDP shipping available." },
    ...
    faqs: [
      ...
      { q: "What is the MOQ for Oktoberfest wholesale?", a: "50 sets per design and colorway, with free size splits inside the MOQ. Volume pricing tiers at 500+, 1,000+ and 5,000+ sets for festival chains and multi-store retailers." },
  ...
  // ─────────────── 9. STREETWEAR PAKISTAN ───────────────
  {
    ...
    metaDescription:
      "Heavyweight streetwear manufacturer in Pakistan. 320–500 GSM hoodies, oversized tees, cargos. MOQ 50. Puff print, embroidery. Export USA, UK, EU.",
    ...
    intro: [
      ...
      "Our Start-Up Program is designed for emerging streetwear labels and influencer drops — MOQ 50 pieces per color, free tech-pack support, expedited sampling and tight lead times. Established brands and retailers benefit from dedicated production lines, named QC supervisors and factory-direct pricing without trader margins.",
    ],
    whyChoose: [
      ...
      { title: "Start-up program MOQ", body: "50 pieces per color across hoodies, tees and sweatpants — same heavyweight fabric, finishing and trims used for larger brands. Free tech-pack support for confirmed POs." },
  ...
  // ─────────────── 10. CUSTOM APPAREL PAKISTAN ───────────────
  {
    ...
    metaDescription:
      "Custom apparel manufacturer in Pakistan. OEM, ODM & private label across sportswear, leatherwear, streetwear & trachten. MOQ 50. Worldwide export.",
    ...
    whyChoose: [
      ...
      { title: "Audited compliance", body: "WRAP, Sedex SMETA 4-Pillar and BSCI audits on a rolling basis. REACH, OEKO-TEX, GRS, LWG, CITES documentation per shipment." },
    ...
    capabilities: [
      ...
      { title: "Leatherwear", body: "Leather jackets, biker apparel, leather trousers, vests, accessories — in lambskin, cowhide, suede and waxed buffalo from LWG-rated tanneries." },
    ...
    faqs: [
      ...
      { q: "Are you audited for social compliance?", a: "Yes. We maintain rolling WRAP, Sedex SMETA 4-Pillar and BSCI audits. Audit reports shared with buyers on request and we welcome buyer-funded third-party audits at any time." },
...
const buildCountryPage = (i: CountryPageInput): SeoLandingPage => ({
  ...
  metaDescription: `${i.primaryKeyword} from Sialkot. OEM, ODM & private label production for ${i.country} buyers. MOQ 50. Shipping ${i.shippingLane} in ${i.transitDays}.`.slice(0, 158),
  ...
  whyChoose: [
    ...
    { title: "Audited compliance", body: "Rolling WRAP, Sedex SMETA 4-Pillar, BSCI and OEKO-TEX Standard 100 audits — meeting the supply-chain due-diligence requirements of EU CSDDD, German LkSG, UK Modern Slavery Act and US FLA." },
    { title: "Low MOQs from 50 pieces", body: "Start with 50 pieces per design and colourway — ideal for emerging labels, Kickstarter campaigns, capsule drops and seasonal collections without locking up working capital." },
...
const COUNTRY_PAGES: SeoLandingPage[] = [
  buildCountryPage({
    ...
    capabilities: [
      ...
      { title: "Technical sportswear", body: "Sublimated football kits, cycling jerseys, trail running apparel and gym wear in GRS-certified recycled polyester and OEKO-TEX dyed knits — built to EU REACH compliance for direct retail." },
      ...
      { title: "Leatherwear", body: "Cowhide, lambskin and goatskin jackets, vests and bomber styles from LWG-rated tanneries — meeting REACH chromium-VI limits for the German market." },
  ...
  buildCountryPage({
    ...
    faqs: [
      { q: "Is your Lederhosen genuine leather?", a: "Yes — full-grain cowhide, goatskin suede or lambskin Nappa from LWG-rated tanneries. We never substitute split-grain, bonded or synthetic leather without explicit written agreement, and we provide leather material certificates with every shipment." },
      ...
      { q: "What is the MOQ for Lederhosen?", a: "MOQ is 50 pieces per design across sizes — for example 50 pieces split across sizes 46 to 56 in a single Lederhosen style. Multi-colour or multi-style splits are accepted from 30 pieces per variant on dedicated programs." },
  ...
  buildCountryPage({
    ...
    capabilities: [
      ...
      { title: "Gym wear & athleisure", body: "Compression leggings, training shorts, sports bras, oversized tees and tank tops in OEKO-TEX certified knits — designed for high-humidity Gulf training environments." },
    ...
    faqs: [
      ...
      { q: "What is the MOQ for UAE buyers?", a: "MOQ is 50 pieces per design and colourway. For corporate uniforms and school programs we accept multi-size splits across a single design from 50 pieces total." },
  ...
  buildCountryPage({
    ...
    capabilities: [
      ...
      { title: "Activewear & gym wear", body: "Compression leggings, training shorts, sports bras, athleisure sets and yoga apparel in OEKO-TEX and GRS-certified recycled poly knits — built for US fitness studios, gym brands and DTC labels." },
      { title: "Leatherwear", body: "Full-grain cowhide and lambskin jackets, vests and bomber styles from LWG-rated tanneries — compliant with CPSIA and California Prop 65 chemical disclosure requirements." },
  ...
  buildCountryPage({
    ...
    capabilities: [
      ...
      { title: "Leatherwear", body: "Cowhide, lambskin and goatskin jackets, biker styles, vests and bomber jackets from LWG-rated tanneries — REACH compliant for the UK and EU markets." },
