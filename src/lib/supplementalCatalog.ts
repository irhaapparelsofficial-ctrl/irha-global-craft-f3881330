...
const SUPPLEMENTAL_PRODUCTS: SupplementalProductDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Short-cut Bavarian-style Lederhosen in a dark brown colourway with ornamental scroll embroidery, a traditional front flap and matching suspenders, prepared for wholesale and private-label buyer programs.",
    specs: [
      "Ornamental scroll embroidery",
    ...
    seoDescription:
      "Dark brown scroll-embroidered short Lederhosen for wholesale and private-label programs from Irha Apparels, a B2B apparel manufacturer in Sialkot, Pakistan.",
    shortDescription:
  ...
  },
  {
    ...
    description:
      "Short-cut Bavarian-style Lederhosen in an antique brown colourway with ornamental scroll embroidery, contrast piping and matching suspenders, prepared for wholesale and private-label buyer programs.",
    specs: [
      "Ornamental scroll embroidery",
      "Antique brown visual finish",
    ...
    seoDescription:
      "Antique brown scroll-embroidered short Lederhosen for wholesale and private-label programs from Irha Apparels, a B2B apparel manufacturer in Sialkot, Pakistan.",
    shortDescription:
