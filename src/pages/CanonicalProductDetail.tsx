...
import {
  ...
  usePublishedCatalogTaxonomyRelease,
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-2 border px-5 py-4 text-xs uppercase tracking-[0.3em] transition-colors ${inCompare ? "border-primary text-primary" : "border-border/60 hover:border-primary disabled:cursor-not-allowed disabled:opacity-45"}`}
                ><GitCompareArrows size={16} />{inCompare ? "In Compare" : compareFull ? "Compare Full" : "Compare"}</button>
              </div>
