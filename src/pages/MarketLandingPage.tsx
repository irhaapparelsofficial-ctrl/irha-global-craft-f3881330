    ...
    <>
      ...
      <main className="container-luxe py-16 md:py-24 max-w-6xl">
        ...
        <section className="mt-16 border border-gold/35 bg-gold/5 p-7 md:p-10 grid md:grid-cols-[auto_1fr] gap-5 items-start">
          ...
          <div>
            <h2 className="font-display text-2xl md:text-3xl">Established manufacturer. Newly launched buyer platform.</h2>
            <p className="text-sm text-foreground/70 leading-relaxed mt-3">Irha Apparels is an established apparel manufacturer in Sialkot. Buyers in {market.country} can verify the relevant manufacturing program through a live factory video call, documented requirements, samples and buyer-trust evidence before making an order decision.</p>
