-- The sitemap queue/finalizer and Vault-authorized Edge Function are internal.
-- Browsers and generic signed-in sessions must not call their SECURITY DEFINER
