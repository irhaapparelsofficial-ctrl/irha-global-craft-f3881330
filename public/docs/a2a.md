...
It does not use an unrestricted generative backend, submit buyer data, send email, publish social content, access CRM records or make commercial commitments.
...
Streaming, push notifications and extended agent cards are explicitly declared unsupported and return the corresponding A2A error.
