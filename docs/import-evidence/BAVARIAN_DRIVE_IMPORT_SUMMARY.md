# Bavarian Drive Media Import — Production Evidence

Generated: 2026-07-13

## Imported library

- Source folders processed: 29
- Drive inventory: 1,516 files
- Publicly downloadable files: 1,473
- Public-link failures preserved with file IDs: 43
- Image candidates: 1,470
- Accepted unique assets: 1,438
- Rejected duplicates / undersized assets: 32
- Cross-batch exact duplicates removed: 2
- Assets re-encoded to prevent size regression: 156
- Missing generated assets: 0
- Uncategorized output paths: 0
- Materially oversized outputs: 0
